  ...
  return (
    <div className="w-11/12 mx-auto px-3 py-6 mt-8 md:mt-15 mb-2 rounded-2xl bg-base-200">
      ...
      <p className="text-center mb-8">
        {" "}
        Small daily actions lead to big life changes—build habits that shape a
        better you.
      </p>
      ...
      <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
        ...
        <div className="card bg-white shadow-md border border-purple-200 hover:shadow-lg transition">
          <div className="card-body items-center text-center">
            ...
            <p className="text-sm text-gray-700">
              Create routines that sharpen your concentration and help you stay
        ...
        <div className="card bg-white shadow-md border border-purple-200 hover:shadow-lg transition">
          <div className="card-body items-center text-center">
            ...
            <p className="text-sm text-gray-700">
              Consistent habits simplify your day and reduce decision fatigue,
        ...
        <div className="card bg-white shadow-md border border-purple-200 hover:shadow-lg transition">
          <div className="card-body items-center text-center">
            ...
            <p className="text-sm text-gray-700">
              Daily repetition helps build self-control and boosts your ability
        ...
        <div className="card bg-white shadow-md border border-purple-200 hover:shadow-lg transition">
          <div className="card-body items-center text-center">
            ...
            <p className="text-sm text-gray-700">
              Visual progress charts keep you motivated and help you celebrate
              your small wins every day.
            </p>
          </div>
        </div>
      </div>
